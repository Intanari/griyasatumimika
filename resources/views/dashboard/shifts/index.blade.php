                    ...
                    <table class="sf-table">
                        ...
                        <tbody>
                            @foreach($shifts as $i => $s)
                                <tr>
                                    <td class="sf-td-no">{{ $i + 1 }}</td>
                                    <td><span class="sf-nama">{{ $s->nama }}</span></td>
                                    <td><span class="sf-time">{{ \Carbon\Carbon::parse($s->jam_mulai)->format('H:i') }}</span></td>
                                    <td><span class="sf-time">{{ \Carbon\Carbon::parse($s->jam_selesai)->format('H:i') }}</span></td>
                                    <td>
                                        <div class="sf-actions">
                                            ...
                                            <form action="{{ route('dashboard.shifts.destroy', $s) }}" method="POST" class="sf-action-form" onsubmit="return confirm('Yakin ingin menghapus shift ini?');">
                                                @csrf
                                                @method('DELETE')
