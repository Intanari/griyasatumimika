...
@section('title', 'Edit Tahapan Rehabilitasi')
@section('topbar-title', 'Edit Tahapan Rehabilitasi')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Edit Tahapan Rehabilitasi</h2>
            <p class="admin-account-form-subtitle">Ubah no urut, status, judul, dan keterangan.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.layanan.tahapan-rehabilitasi.update', $tahapanRehabilitasi) }}" method="POST" class="admin-account-form">
        @csrf
        @method('PUT')
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="number" id="no_urut" name="no_urut" value="{{ old('no_urut', $tahapanRehabilitasi->no_urut) }}" required min="1">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="status" name="status" value="{{ old('status', $tahapanRehabilitasi->status) }}" maxlength="100">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul', $tahapanRehabilitasi->judul) }}" required maxlength="255">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="5">{{ old('keterangan', $tahapanRehabilitasi->keterangan) }}</textarea>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('dashboard.layanan.tahapan-rehabilitasi.show', $tahapanRehabilitasi) }}" class="btn btn-outline">Batal</a>
        </div>
    </form>
</div>
