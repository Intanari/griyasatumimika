...
@section('title', 'Edit Proses Laporan ODGJ')
@section('topbar-title', 'Edit Proses Laporan ODGJ')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Edit Proses Laporan ODGJ</h2>
            <p class="admin-account-form-subtitle">Ubah no urut, judul, dan keterangan.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.layanan.proses-laporan-odgj.update', $prosesLaporanOdgj) }}" method="POST" class="admin-account-form">
        @csrf
        @method('PUT')
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="number" id="no_urut" name="no_urut" value="{{ old('no_urut', $prosesLaporanOdgj->no_urut) }}" required min="1">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul', $prosesLaporanOdgj->judul) }}" required maxlength="255">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="4">{{ old('keterangan', $prosesLaporanOdgj->keterangan) }}</textarea>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('dashboard.layanan.proses-laporan-odgj.show', $prosesLaporanOdgj) }}" class="btn btn-outline">Batal</a>
        </div>
    </form>
</div>
