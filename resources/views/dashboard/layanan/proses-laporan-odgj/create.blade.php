...
@section('title', 'Tambah Proses Laporan ODGJ')
@section('topbar-title', 'Tambah Proses Laporan ODGJ')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Tambah Proses Laporan ODGJ</h2>
            <p class="admin-account-form-subtitle">Isi no urut, judul, dan keterangan yang akan ditampilkan di halaman publik Layanan.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.layanan.proses-laporan-odgj.store') }}" method="POST" class="admin-account-form">
        @csrf
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul') }}" required maxlength="255" placeholder="Contoh: Isi Form Laporan">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="4" placeholder="Deskripsi singkat...">{{ old('keterangan') }}</textarea>
