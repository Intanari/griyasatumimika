...
@section('topbar-title', 'Edit Profil Yayasan')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Edit Profil Yayasan</h2>
            <p class="admin-account-form-subtitle">Ubah judul dan keterangan yang ditampilkan di halaman publik.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.profil-yayasan.update', $profilYayasan) }}" method="POST" class="admin-account-form">
        @csrf
        @method('PUT')
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul', $profilYayasan->judul) }}" required maxlength="255" placeholder="Contoh: Profil dan Identitas">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="6" placeholder="Isi deskripsi atau isi profil...">{{ old('keterangan', $profilYayasan->keterangan) }}</textarea>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('dashboard.profil-yayasan.show', $profilYayasan) }}" class="btn btn-outline">Batal</a>
        </div>
    </form>
</div>
