...
@section('topbar-title', 'Tambah Visi Misi')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Tambah Visi Misi</h2>
            <p class="admin-account-form-subtitle">Isi judul dan keterangan yang akan ditampilkan di halaman publik Visi & Misi.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.visi-misi.store') }}" method="POST" class="admin-account-form">
        @csrf
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul') }}" required maxlength="255" placeholder="Contoh: Visi Kami">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="6" placeholder="Isi visi atau misi...">{{ old('keterangan') }}</textarea>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('dashboard.visi-misi.index') }}" class="btn btn-outline">Batal</a>
        </div>
    </form>
</div>
