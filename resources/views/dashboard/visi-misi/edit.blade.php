...
@section('topbar-title', 'Edit Visi Misi')
...
<div class="card admin-account-form-card">
    <div class="admin-account-form-header">
        ...
        <div>
            <h2 class="admin-account-form-title">Edit Visi Misi</h2>
            <p class="admin-account-form-subtitle">Ubah judul dan keterangan yang ditampilkan di halaman publik.</p>
        </div>
    </div>

    <form action="{{ route('dashboard.visi-misi.update', $visiMisi) }}" method="POST" class="admin-account-form">
        @csrf
        @method('PUT')
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul', $visiMisi->judul) }}" required maxlength="255" placeholder="Contoh: Visi Kami">
        ...
        <div class="admin-account-section">
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" rows="6" placeholder="Isi visi atau misi...">{{ old('keterangan', $visiMisi->keterangan) }}</textarea>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('dashboard.visi-misi.show', $visiMisi) }}" class="btn btn-outline">Batal</a>
        </div>
    </form>
</div>
