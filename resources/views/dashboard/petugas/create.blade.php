            ...
            <div class="petugas-form-grid petugas-form-grid-single">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" required>
                        <option value="petugas_rehabilitasi" {{ old('role', 'petugas_rehabilitasi') === 'petugas_rehabilitasi' ? 'selected' : '' }}>Petugas (User)</option>
                        <option value="manajer" {{ old('role') === 'manajer' ? 'selected' : '' }}>Petugas Manajer</option>
                        <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Petugas Admin (Super Admin)</option>
                    </select>
