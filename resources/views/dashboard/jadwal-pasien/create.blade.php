        ...
        <div class="rw-form-grid">
            ...
            <div class="rw-form-group">
                ...
                <select name="reminder_before_minutes" class="rw-input {{ $errors->has('reminder_before_minutes') ? 'rw-invalid' : '' }}">
                    ...
                    <option value="2" {{ old('reminder_before_minutes') == 2 ? 'selected' : '' }}>2 menit sebelum</option>
                    <option value="5" {{ old('reminder_before_minutes') == 5 ? 'selected' : '' }}>5 menit sebelum</option>
                    <option value="15" {{ old('reminder_before_minutes') == 15 ? 'selected' : '' }}>15 menit sebelum</option>
                    <option value="30" {{ old('reminder_before_minutes') == 30 ? 'selected' : '' }}>30 menit sebelum</option>
                    <option value="60" {{ old('reminder_before_minutes') == 60 ? 'selected' : '' }}>1 jam sebelum</option>
                    <option value="300" {{ old('reminder_before_minutes') == 300 ? 'selected' : '' }}>5 jam sebelum</option>
                    <option value="600" {{ old('reminder_before_minutes') == 600 ? 'selected' : '' }}>10 jam sebelum</option>
                    <option value="1440" {{ old('reminder_before_minutes') == 1440 ? 'selected' : '' }}>1 hari sebelum</option>
                    <option value="2880" {{ old('reminder_before_minutes') == 2880 ? 'selected' : '' }}>2 hari sebelum</option>
                    <option value="4320" {{ old('reminder_before_minutes') == 4320 ? 'selected' : '' }}>3 hari sebelum</option>
                </select>
