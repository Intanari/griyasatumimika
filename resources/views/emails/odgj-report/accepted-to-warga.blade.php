...
<head>
    ...
    <title>Laporan Diterima – PeduliJiwa</title>
    <style>
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%;">
                ...
                <tr>
                    <td style="background: #ffffff; border-radius: 0 0 24px 24px; box-shadow: 0 20px 60px rgba(59,130,246,0.12); padding: 32px 36px;">
                        ...
                        <p style="font-size: 14px; color: #64748b; line-height: 1.6;">Terima kasih atas kepedulian Anda. Salam hangat dari tim PeduliJiwa.</p>
                    </td>
                </tr>
