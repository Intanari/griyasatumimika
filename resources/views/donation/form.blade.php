...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .selected-program { background: white; border: 1.5px solid #e0e0f8; border-radius: 14px; padding: 1rem 1.25rem; display: flex; align-items: center; gap: 12px; margin-bottom: 2rem; }
        .prog-icon { width: 44px; height: 44px; background: linear-gradient(135deg, #4f46e5, #7c3aed); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.3rem; flex-shrink: 0; }
        ...
        .preset-btn:hover, .preset-btn.active { border-color: #4f46e5; color: #4f46e5; background: rgba(79,70,229,0.08); }
