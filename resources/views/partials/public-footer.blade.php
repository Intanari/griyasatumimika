<footer class="footer">
    <div class="footer-grid footer-grid-simple">
        ...
        <div><div class="footer-col-title">Kontak</div><div class="footer-links"><a href="tel:082198595245">0821-9859-5245</a><a href="mailto:info@griyasatumimika.web.id">info@griyasatumimika.web.id</a><span>Timika, Kab. Mimika, Papua Tengah</span></div></div>
    </div>
    <div class="footer-bottom">
        <div>© {{ date('Y') }} Griya Satu Mimika — Yayasan Peduli Kasih Mimika. Dibuat dengan ❤️ untuk mereka yang berjuang pulih.</div>
    </div>
</footer>
